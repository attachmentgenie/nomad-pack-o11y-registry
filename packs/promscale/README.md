...
```
nomad-pack run promscale --var message="Hola Mundo!"
```
...
balance the Consul service `promscale-service`, which is the default value
...
- `consul_service_tags` (list of string) - The consul service name for the
  promscale application
- `consul_service_name` (string) - The consul service name for the promscale
  application
