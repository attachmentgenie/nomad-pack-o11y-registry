...
```
nomad-pack run grafana_agent --var message="Hola Mundo!"
```
...
balance the Consul service `grafana_agent-service`, which is the default value
...
- `consul_service_name` (string) - The consul service name for the grafana_agent
  application
