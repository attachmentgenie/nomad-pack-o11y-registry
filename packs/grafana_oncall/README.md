...
balance the Consul service `grafana_oncall-service`, which is the default value
...
- `consul_service_tags` (list of string) - The consul service name for the
  grafana_oncall application
- `consul_service_name` (string) - The consul service name for the grafana_oncall
  application
